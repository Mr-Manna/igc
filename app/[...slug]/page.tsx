 ...
 *
 * This build covers the homepage only. Rather than let navigation 404, each known
 * route resolves to this page. `dynamicParams = false` means genuinely unknown
 * paths still return a real 404 rather than a stub.
 */

const stubRoutes = allRoutes.filter((route) => route !== "/");
    ...
    <section className="bg-surface">
      <div className="shell flex min-h-[60vh] flex-col justify-center py-24">
        ...
        <p className="measure mt-6 text-slate">
          This section is being rebuilt. The homepage is the first page of the new
          design system; the remaining routes follow in the next pass.
        </p>
